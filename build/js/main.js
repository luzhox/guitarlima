...
var map = {
	"./course-percat.js": "./src/course-percat.js",
	"./index.js": "./src/index.js",
	"./owl.carousel.js": "./src/owl.carousel.js",
	"./page-modules.js": "./src/page-modules.js",
...
(function ($) {
  ...
  function CoursePerCat($el) {
    ...
    this.isAnimating = false; // Validate required elements exist
  ...
  CoursePerCat.prototype.setupInitialState = function () {
    ...
    console.log('CoursePerCat: Available filter buttons:', this.$filterButtons.map(function () {
      return $(this).data('category');
    }).get()); // Find the button for the initial category
    ...
    if ($initialButton.length > 0) {
      this.updateActiveButton($initialButton); // Apply initial filter
  ...
  CoursePerCat.prototype.filterItems = function (category) {
    const self = this;
    this.isAnimating = true; // Use jQuery's promise-based animation with improved effects
    ...
    this.$items.each(function (index) {
      ...
      if (hasCategory) {
        ...
        const hidePromise = $item.animate({
          'opacity': 0
        }, {
          duration: self.animationDuration,
          step: function (now) {
  ...
  CoursePerCat.prototype.updateActiveButton = function ($activeButton) {
    ...
    this.$filterButtons.removeClass('active'); // Add active class to clicked button with simple animation
  ...
  window.CoursePerCat = CoursePerCat; // Auto-initialize if data attribute is present
...
})(jQuery); // CommonJS export for Node.js environments
...
/* harmony import */ var _styles_sass_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/sass/style.scss */ "./styles/sass/style.scss");
/* harmony import */ var _styles_sass_style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_styles_sass_style_scss__WEBPACK_IMPORTED_MODULE_0__);
__webpack_require__(/*! ./page-modules */ "./src/page-modules.js");

__webpack_require__(/*! ./owl.carousel */ "./src/owl.carousel.js");

__webpack_require__(/*! ./template */ "./src/template.js"); // Direct initialization for course-percat module
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (coursePerCatElements.length > 0) {
    try {
      const CoursePerCat = __webpack_require__(/*! ./course-percat.js */ "./src/course-percat.js");
...
function PageModules() {
  ...
  for (var i = 0; i < modules.length; i++) {
    ...
    try {
      ...
      var Module = __webpack_require__("./src sync recursive ^\\.\\/.*\\.js$")("./" + name + ".js");
