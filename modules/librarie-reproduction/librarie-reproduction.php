...
<?php if(get_sub_field('description')): ?>
  <div class="course-reproduction__description">
    <div class="course-reproduction__description__content">
      <?php $image = get_sub_field('image'); ?>
      <?php if($image): ?>
        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>">
      <?php endif; ?>
      <h3>Sobre la librería</h3>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    ...
    $('#description').on('click', function() {
      $('.course-reproduction__list').removeClass('active');
      $('.course-reproduction__description').toggleClass('active');
      if($('.course-reproduction__description').hasClass('active')){
        $('body').css('overflow', 'hidden');
        $('.overlay').addClass('active');
      }else{
        $('body').css('overflow', 'auto');
