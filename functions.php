<?php
  ...
  require('inc/admin-style.php'); // Admin: branding ligero + login personalizado (el skin oscuro se retiró)
  require('inc/woocommerce-account.php');
  require('inc/plan-pro-checkout.php');
  require('inc/members-content-permissions-fix.php'); // Fix guardado meta _members_access_role (Members)
  require('inc/canciones-admin.php'); // Canciones: categorías vía campo ACF, oculta panel nativo
  require('inc/canciones-bulk.php'); // Canciones: carga masiva + asignación masiva de categorías
